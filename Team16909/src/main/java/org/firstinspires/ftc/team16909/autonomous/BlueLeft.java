...
public class BlueLeft extends LinearOpMode {
    ...
    private final Pose2d posHub = new Pose2d(19.3338, -18.4224, Math.toRadians(0));
    private final Pose2d posApproach = new Pose2d(-1, 0, 0);
    private final Pose2d posWarehouse = new Pose2d(-2, 38.3931, Math.toRadians(0));
                ...
                if (updatedRecognitions != null) {
                    ...
                    for (Recognition recognition : updatedRecognitions) {
                        ...
                        if (recognition.getLabel().indexOf("Duck") > -1) {
                            if (recognition.getLeft() > 850) {
                                telemetry.addData("Position: ", "Right");
                                tgtPos = 3;
                            } else if (recognition.getLeft() < 850 && recognition.getLeft() > 350) {
                    ...
                    telemetry.update();
                    if (updatedRecognitions.size() == 0) tgtPos = 1;
                }
            }
        }
