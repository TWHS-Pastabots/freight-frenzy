...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(7, 0, 1,
            12);
    ...
    public static double GEAR_RATIO = 1.041022883; // output (wheel) speed / input (motor) speed
