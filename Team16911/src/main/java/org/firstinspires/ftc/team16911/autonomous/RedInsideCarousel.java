...
public class RedInsideCarousel extends LinearOpMode
{
    ...
    private Pose2d firstPosition = new Pose2d(24, 19, 0);
    private Pose2d secondPosition = new Pose2d(24,60, 0);
    private Pose2d thirdPosition = new Pose2d(1.5, 60, 0);
    private Pose2d fourthPosition = new Pose2d(24, 62, 0);
    private Pose2d fifthPosition = new Pose2d(24, 0, 0);
    private Pose2d sixthPosition = new Pose2d(0, 0, 0);
    private Pose2d seventhPosition = new Pose2d(0, -32, 0);
    ...
    private void spinCarousel(int waitTime)
    {
