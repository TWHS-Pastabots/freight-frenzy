...
@Autonomous(name = "BlueInsideDistance")
public class BlueInsideDistance extends LinearOpMode
{
    ...
    private final Pose2d firstPosition = new Pose2d(20, 0, 0);
    private final Pose2d hubLevelOnePose = new Pose2d(13.3, -17, 0);
    private final Pose2d hubLevelTwoPose = new Pose2d(16.3, -17, 0);
    private final Pose2d hubLevelThreePose = new Pose2d(22, -17, 0);
