...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(1.5, 0, .5,
            1.092450864064676);
    ...
    public static double GEAR_RATIO = 1.037479067690439; // output (wheel) speed / input (motor) speed
     ...
     */
    public static double MAX_VEL = 32.80042774735428;
    public static double MAX_ACCEL = 39.4224324932042;
    public static double MAX_ANG_VEL = Math.toRadians(180.69912);
    public static double MAX_ANG_ACCEL = Math.toRadians(180.69912);
