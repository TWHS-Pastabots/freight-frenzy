...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(12, 0, 0.02,
            12.462966806020068);
    ...
    public static double GEAR_RATIO = 1 * (65/60.454100535787504); // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 10.165; // in
     ...
     * inches.
     */
    public static double MAX_VEL = (49.5265 * 0.6);
